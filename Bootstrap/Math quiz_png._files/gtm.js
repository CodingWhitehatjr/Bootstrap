...
"resource": {
  ...
  "rules":[
    ...
    [["if",13,21,22],["add",6]],
    [["if",13,21,23],["add",6]],
    [["if",24],["add",7,8,21,23,24,28,29,30,31,33,34,35]],
    [["if",25,26],["add",9,10]],
    [["if",1,27,28],["add",11]],
...
var Md=[E.B,E.F],Nd=function(a){var b=a[E.Zd];b&&Ac(40);var c=a[E.$d];c&&Ac(41);for(var d=Ba(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==E.Zd&&f!==E.$d)if(-1<m(Md,f)){var h=f,k=a[f],l=d[e];xd().set(h,k,l,"US","US-NJ",c)}else{}},Od=function(a,
